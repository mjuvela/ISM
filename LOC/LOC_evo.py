...
def SolveCL(first_call=False):
    ...
    global SOL_SIJ_buf, SOL_ESC_buf                             
    ...
    if (first_call):  # first itearation => set up buffers
    ...
    for ibatch in range(CELLS//BATCH):
        ...
        SOL_RHO_buf, SOL_TKIN_buf, SOL_ABU_buf,  PL_buf, SOL_SIJ_buf, SOL_ESC_buf,  RES_buf,  SOL_WRK_buf)
